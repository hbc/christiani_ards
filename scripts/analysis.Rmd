...
write.table(deceased, file="deceased.tsv", sep="\t", quote=FALSE, col.names=TRUE)
kable(head(icu), format="html")
write.table(icu, file="icu.tsv", sep="\t", quote=FALSE, col.names=TRUE)
kable(head(not_deceased), format="html")
write.table(not_deceased, file="not_deceased.tsv", sep="\t", quote=FALSE, col.names=TRUE)
```
...
write.table(deceased_corrected, file="deceased_corrected.tsv", sep="\t",
  quote=FALSE, col.names=TRUE)
kable(head(deceased_corrected), format="html")
write.table(icu_corrected, file="icu_corrected.tsv", sep="\t",
  quote=FALSE, col.names=TRUE)
kable(head(icu_corrected), format="html")
write.table(not_deceased_corrected, file="not_deceased_corrected.tsv", sep="\t",
  quote=FALSE, col.names=TRUE)
